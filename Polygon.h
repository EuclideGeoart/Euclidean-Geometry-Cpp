...
class Polygon : public GeometricObject {
 public:
   ...
   */
  Polygon(const std::vector<Point_2>& vertices, const sf::Color& color = sf::Color::White, unsigned int id = 0);

  Polygon(const std::vector<std::shared_ptr<Point>>& vertices, const sf::Color& color = sf::Color::White, unsigned int id = 0);
